...
function LeftNav() {
  return (
    <div className='bg-[#181818] w-[20%] h-[150vh] border-zinc-200 border-r-[1px] mr-10'>
    ...
    <div className='flex flex-col  text-[#F1F1F1] ml-10  text-[1rem] font-semibold mr-5'>
      <Link to={'/about'} className='flex rounded-lg hover:bg-[#F4A261] gap-3 text-[#F1F1F1] p-6 pl-3'>
